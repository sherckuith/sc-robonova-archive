...
IF BT = 0 THEN GOTO main
IF  old_key = BT THEN GOTO main
    old_key = BT

'L
IF BT=71 THEN GOTO k29 

IF BT=65 THEN GOTO K20 ' D for right_attack
IF BT=66 THEN GOTO K12 'Down 
IF BT=67 THEN GOTO k24  'Right 
IF BT=68 THEN GOTO k22 'Left
IF BT=69 THEN GOTO k25 'UP

IF BT=70 THEN GOTO K10 ' R 

IF BT=72 THEN GOTO K21 ' C
IF BT=73 THEN GOTO K15 ' A

IF BT=74 THEN GOTO K31 ' B

IF BT=75 THEN GOTO k2  'start 
'-----------------------------
