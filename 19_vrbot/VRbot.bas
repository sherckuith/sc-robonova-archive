...
'
' VRbot Template
' (edit as required before running, see line 208 and below)
'
'================================================
...
CONST GROUP_1  = 1    '(Command count: 6)
...
IF VRA1 = RES_WAITING THEN
	...
	IF RR > 0 THEN GOTO do_rr
	'check command from RC
	A = REMOCON(1)  
	IF A > 0 THEN GOTO do_rc
	
	'<--- add other checking here (will increase blink delay)
...
MUSIC "FCFCFCFC"
PRINT " -> Command "
PRINT FORMAT(VRCOMMAND,DEC,2)

'<--- implement actions based on VRGROUP and VRCOMMAND
'example:
IF VRGROUP = GROUP_0 THEN VRGROUP = GROUP_1 ' activate command group

IF VRGROUP = GROUP_1 THEN
	IF VRCOMMAND = 1 THEN ' Considering MOVE as word 1 of Group 1
	MUSIC "FFFF"
	...
	ENDIF
	'do command
	ON VRCOMMAND GOTO K1,K2,K3,K4,K5,K6,K7,K8,K9,K10,K11,K12,K13,K14,K15,K16,K17,K18,K19,K20,K21,K22,K23,K24,K25,K26,K27,K28,K29,K30,K31,K32
ENDIF
