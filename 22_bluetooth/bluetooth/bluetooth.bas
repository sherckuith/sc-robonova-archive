...
IF RxIn = 0 THEN GOTO MAIN
IF  OLD_KEY = RxIn THEN GOTO MAIN
    OLD_KEY = RxIn

'A = bow
IF RxIn=65 THEN GOTO k1
'B = hands up 
IF RxIn=66 THEN GOTO k2
'C = sit down
IF RxIn=67 THEN GOTO k3
'D = sit with hands up
IF RxIn=68 THEN GOTO k4
'E = foot up
IF RxIn=69 THEN GOTO k5
